    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="text-2xl font-bold text-slate-800 mb-8 text-center">What&apos;s Included</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-xl mx-auto px-5">
          <h2 className="text-2xl font-bold text-slate-800 mb-2 text-center">Ready to get started?</h2>
          <p className="text-slate-500 text-center mb-8">Request a quote below — it&apos;s free.</p>
