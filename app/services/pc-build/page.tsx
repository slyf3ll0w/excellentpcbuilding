  ...
  return (
    <>
      ...
      <section className="bg-[#060B16] pt-16 pb-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_60%_at_80%_50%,rgba(0,112,255,0.08),transparent)]" />
        <div className="max-w-6xl mx-auto px-5 relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-2xl overflow-hidden h-72 lg:h-96">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#060B16]/50 to-transparent" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#0A1220]">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="text-2xl font-extrabold text-white mb-8 text-center">What&apos;s Included</h2>
      ...
      <section className="py-20 bg-[#0A1220]">
        <div className="max-w-xl mx-auto px-5">
          <h2 className="text-2xl font-extrabold text-white mb-2 text-center">Ready to get started?</h2>
          <p className="text-gray-500 text-center mb-8">Request a quote below — it&apos;s free.</p>
